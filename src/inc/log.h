...
#elif defined(LOG_DEVICE_NULL)
    static __inline int hal_log_init(void) {return 0;}
    static __inline int hal_log_deinit(void) {return 0;}
    static __inline int hal_log_send(uint8_t *p, uint8_t s) {return 0;}
#else
